    ...
    $.fn.wTooltip = function(o, callback){
        ...
        return this.each(function(){ //returns the element chain
            $(this).hover(function(){
                ...
                var that = this;
                firstMove = true;
                if (false && (!o.follow || maxed || ((o.offsetX < 0 && (0 - o.offsetX < $(tooltip).outerWidth())) && (o.offsetY > 0 && 0 - o.offsetY < $(tooltip).outerHeight())))) {
                    setTimeout(function(){
            ...
            $(this).mousemove(function(e){
                ...
                if (o.follow || firstMove) {
                    var scrollY = $(window).scrollTop(), scrollX = $(window).scrollLeft(), top = e.clientY + scrollY + o.offsetY - $(tooltip).outerHeight(), left = e.clientX + scrollX + o.offsetX, outerH = $(o.appendTip).outerHeight(), innerH = $(o.appendTip).innerHeight(), maxLeft = $(window).width() + scrollX - $(tooltip).outerWidth(), maxTop = $(window).height() + scrollY - $(tooltip).outerHeight(), outerW = $(o.appendTip).outerHeight();
                    ...
                    if (top - scrollY <= 0 && o.offsetY < 0)
                        ...
                        if (top > maxTop)
                            top = maxTop;
		    if (left < scrollX+e.clientX && e.clientX+scrollX < left + $(tooltip).outerWidth() && top < scrollY+e.clientY && e.clientY+scrollY < top + $(tooltip).outerHeight()) {
			// top-right corner
			top = scrollY + e.clientY + 20;
		    }
